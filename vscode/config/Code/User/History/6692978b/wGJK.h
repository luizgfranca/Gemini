...
namespace application::ui::component {
    ...
    private:
        ...
        PropertyValueListRow m_serviceproperty_loaded;
        PropertyValueListRow m_serviceproperty_state;
        PropertyValueListRow m_serviceproperty_followed;
        PropertyValueListRow m_serviceproperty_object_path;
        PropertyValueListRow m_serviceproperty_job_type;
        PropertyValueListRow m_serviceproperty_job_object_path;
