...
client::dbus::systemd::list_units_response_t& State::sort_units(client::dbus::systemd::list_units_response_t& units_list) {
    std::sort(units_list.begin(), units_list.end())
}
