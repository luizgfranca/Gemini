...
std::unique_ptr<std::vector<Unit>> Unit::from_dbus_list_units_and_list_files_response(
    ...
    auto raw_units = std::make_shared<std::vector<Unit>>(Unit::from_dbus_list_units_response(list_units_response));
    auto unit_files = std::make_shared<std::vector<UnitFile>>(UnitFile::from_list_unit_file_response(list_unit_files_response));
