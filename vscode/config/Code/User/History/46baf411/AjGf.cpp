...
std::shared_ptr<std::vector<std::string>> SystemdManager::get_unit_path_property() {
    return std::make_shared<std::vector<std::string>>(proxy->getProperty(manager::property_name::UNITS_PATH)
        .onInterface(manager::INTERFACE_NAME)
