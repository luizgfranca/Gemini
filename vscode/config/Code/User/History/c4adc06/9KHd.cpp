...
void ServiceDetailsSection::setup_styles() {
    ...
    m_serviceproperty_description.set_margin(5);
    m_serviceproperty_description.set_margin_top(10);
    m_serviceproperty_description.set_margin_bottom(10);
    m_serviceproperty_description.set_margin_start(5);
    m_serviceproperty_description.set_margin_end(5);
}
