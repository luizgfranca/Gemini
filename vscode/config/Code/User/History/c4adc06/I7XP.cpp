...
void ServiceDetailsSection::setup_components() {
    set_child(m_container_box);

    m_container_box.append(m_serviceproperty_title);
    m_container_box.append(m_serviceproperty_description);

    m_property_list_frame.set_child(m_property_listbox);
    m_container_box.append(m_property_list_frame);
...
void ServiceDetailsSection::setup_style() {
    ...
    m_container_box.add_css_class("frame");
    m_container_box.set_orientation(Gtk::Orientation::VERTICAL);
