...
namespace provider::systemd {
    ...
    public:
        ...
        std::string unit_file_path;

        std::string unit_file_containing_folder;
        ...
        Unit(
            ...
            unit_file_containing_folder(unit_file_containing_folder)            
        {}
        ...
        static std::unique_ptr<std::vector<Unit>> from_dbus_list_units_and_list_files_response(
