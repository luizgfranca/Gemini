...
private:
    ...
    Gtk::ScrolledWindow m_service_grid_scroller;
...
MainWindow::MainWindow() {
    ...
    m_treeview.set_vexpand(false);
    m_treeview.set_vscroll_policy(Gtk::Scrollable::Policy::MINIMUM);
    m_treeview.set_overflow(Gtk::Overflow::HIDDEN);
    m_treeview.set_valign(Gtk::Align::FILL);
    ...
    // m_service_grid_scroller.set_min_content_width(850);
    // m_service_grid_scroller.set_child(m_treeview);
    ...
    // container.append(m_service_grid_scroller);
    container.append(m_treeview);
...
void MainWindow::load_grid_data() {
    ...
    m_treeview.set_fixed_height_mode(true);
    auto scroll_position = m_service_grid_scroller.get_vadjustment()->property_value();

    std::cout << " position: " << scroll_position << "\n" ;
    ...
    std::cout << " position: " << scroll_position << "\n" ;
    m_service_grid_scroller.get_vadjustment()->set_value(scroll_position);

    std::cout << "new  position: " << m_service_grid_scroller.get_vadjustment()->property_value() << "\n" ;
}
