...
void MainWindow::load_grid_data() {
    ...
    double x, y;
    m_service_grid_scroller.translate_coordinates(Widget &dest_widget, double src_x, double src_y, double &dest_x, double &dest_y)
    ...
    // if(scroller_cursor) {
    //     m_service_grid_scroller.get_vscrollbar()->set_adjustment(scroller_cursor);
    // }
