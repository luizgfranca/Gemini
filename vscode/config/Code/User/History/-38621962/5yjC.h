...
namespace module::services {
    ...
    class ServicesManager {
        ...
        void start_service(const provider::systemd::Unit& unit);
        void stop_service(const provider::systemd::Unit& unit);
        void restart_service(const provider::systemd::Unit& unit);
