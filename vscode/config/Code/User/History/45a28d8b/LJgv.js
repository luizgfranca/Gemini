...
function loadFileStream(relativePath, loadedResourceResolver) {
  ...
  fileReadStream.on('error', () => setImmediate(() => loadedResourceResolver(relativePath, null)))
  fileReadStream.on('open', () => setImmediate(() => loadedResourceResolver(relativePath, fileReadStream)))
}
